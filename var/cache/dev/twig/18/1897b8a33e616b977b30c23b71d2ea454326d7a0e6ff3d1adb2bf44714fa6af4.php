...
class __TwigTemplate_efb98ea956ad71bb0ed434438fa37c39a41e6ebb5adda2a1315f707bc3c3d897 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('user_delete', {'id': user.id}) }}\" onsubmit=\"return confirm('¿Esta seguro de borrarlo?');\">
    <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ user.id) }}\">
    <button class=\"btn btn-danger\">Borrar</button>
</form>
", "user/_delete_form.html.twig", "C:\\wamp64\\www\\DAWESE\\aGestion\\templates\\user\\_delete_form.html.twig");
    }
}
