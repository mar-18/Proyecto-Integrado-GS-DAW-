...
class __TwigTemplate_0d1f35fae7b8c2cba3978e496e2543064e5c087c90886572144889486bc3688a extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"container\">
    <div class=\"row\">
      ...
      <div class=\"span8\">
        ...
        echo "\">Listado empleado</a><i class=\"icon-angle-right\"></i></li>          
...
{% block title %}{{parent()}} - Empleado(n){% endblock %}
    ...
    <div class=\"row\">
      ...
      <div class=\"span8\">
        <ul class=\"breadcrumb\">            
          ...
          <li><a href=\"{{ path('empleado_index') }}\">Listado empleado</a><i class=\"icon-angle-right\"></i></li>          
          <li class=\"active\">Nuevo</li>
        </ul>
      </div>
    </div>
...
", "empleado/new.html.twig", "C:\\wamp64\\www\\DAWESE\\aGestion\\templates\\empleado\\new.html.twig");
    }
}
