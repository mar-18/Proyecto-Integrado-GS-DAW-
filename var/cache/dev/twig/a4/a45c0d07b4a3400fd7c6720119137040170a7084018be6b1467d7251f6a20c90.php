...
/* user/new.html.twig */
class __TwigTemplate_89e1bd5f55c5edca4fb2e961c65b76a003233cd3f3a015c97e35fc63a4f6e6c5 extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"container\">
    <div class=\"row\">
      ...
      <div class=\"span8\">
        ...
        echo "\">Listado usuario</a><i class=\"icon-angle-right\"></i></li>          
...
";
    ...
    {
        return array (  187 => 47,  182 => 46,  172 => 45,  157 => 40,  144 => 30,  132 => 21,  128 => 20,  114 => 9,  104 => 8,  91 => 6,  81 => 5,  61 => 3,  38 => 1,);
    }
...
{% block title %}{{parent()}} - Usuario(n){% endblock %}
    ...
    <div class=\"row\">
      ...
      <div class=\"span8\">
        <ul class=\"breadcrumb\">            
          ...
          <li><a href=\"{{ path('user_index') }}\">Listado usuario</a><i class=\"icon-angle-right\"></i></li>          
          <li class=\"active\">Nuevo</li>
        </ul>
      </div>
    </div>
...
{% endblock %}", "user/new.html.twig", "C:\\wamp64\\www\\DAWESE\\aGestion\\templates\\user\\new.html.twig");
    }
}
